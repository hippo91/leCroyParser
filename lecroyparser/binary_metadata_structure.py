...
BinaryMetaDataStructure = UserDict(
    {
        ...
        "vertical_offset": TokenProperties(
            location=160, atomic_type=AtomicType.float32
        ),
        ...
        "sequence_segments": TokenProperties(
            location=144, atomic_type=AtomicType.int32
        ),
        "trigger_seconds": TokenProperties(
            location=296, atomic_type=AtomicType.float64
        ),
        ...
        "vertical_coupling": TokenProperties(
            location=326, atomic_type=AtomicType.uint16
        ),
